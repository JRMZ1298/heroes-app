...
export const HeroBanner = ({ hero }: Props) => {
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                                ...
                                <Badge className={`${hero.status === 'Active' ? 'bg-green-500' : 'bg-red-500'} text-white`}>{hero.status}</Badge>
                                <Badge variant="secondary" className={`${hero.universe === 'DC' ? 'bg-blue-500' : 'bg-red-500'} text-white`}>
                                    {hero.universe}
                                </Badge>
                            </div>
