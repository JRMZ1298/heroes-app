        ...
        <>
            <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
                <div className="relative h-64 ">
                    ...
                    {/* Universe badge */}
                    <Badge className={`absolute top-3 right-3 text-xs ${hero.universe === 'DC' ? 'bg-blue-600' : 'bg-red-600'}  text-white`}>{hero.universe}</Badge>
                ...
                <CardHeader className="py-3 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:-top-2.5 transition-all duration-300">
                    <div className="flex justify-between items-start">
                        ...
                        <Badge className={`text-xs ${hero.category === 'Hero' ? 'bg-green-100 text-green-800 border-green-200' : 'bg-red-100 text-red-800 border-red-200'}`}>{hero.category}</Badge>
                    </div>
