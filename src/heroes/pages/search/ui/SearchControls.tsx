...
export const SearchControls = () => {
    ...
    const activeAcoordion = searchParams.get('active-accordion') ?? '';
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="flex gap-2">
                    <Button variant={activeAcoordion === 'advance-filters' ? 'default' : "outline"} className="h-12"
                        onClick={() => {
                            if (activeAcoordion === 'advance-filters') {
            ...
            {/* Advanced Filters */}
            <Accordion data-testId='accordion' type="single" collapsible value={activeAcoordion}>
