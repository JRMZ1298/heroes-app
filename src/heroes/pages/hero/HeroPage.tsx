...
import { useHero } from "@/heroes/hooks/useHeroPage"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={hero.intelligence * 10} className="h-2" activeColor="bg-purple-500" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={hero.speed * 10} className="h-2" activeColor="bg-yellow-500" />
                                </CardContent>
                            </Card>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={hero.strength * 10} className="h-4" activeColor="bg-orange-500" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={hero.intelligence * 10} className="h-4" activeColor="bg-purple-500" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={hero.speed * 10} className="h-4" activeColor="bg-yellow-500" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={hero.durability * 10} className="h-4" activeColor="bg-green-500" />
                                        </div>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center py-2 border-b">
                                        ...
                                        <Badge className={`${hero.category === 'Hero' ? 'bg-green-500' : 'bg-red-500'} text-white`}>
                                            {hero.category}
                                        </Badge>
                                    </div>
                                    <div className="flex justify-between items-center py-2">
                                        <span className="text-gray-600">Estado:</span>
                                        <Badge className={`${hero.status === 'Active' ? 'bg-green-500' : 'bg-red-500'} text-white`}>
                                            {hero.status}
                                        </Badge>
                                    </div>
                                </CardContent>
